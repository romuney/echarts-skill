...
HUMAN_ONLY = {
    ...
    53: 'расход контекста и момент ПЕРЕДАЧИ — свойство сессии, не файла;'
        ' экономию на чтении даёт scan-layout.py, но проверить её нечем',
    54: 'порядок категорий и выбор масштаба сверяются с макетом глазами:'
        ' что именно означает порядок в макете, знает только человек (SELF_CHECK M10, M11)',
}
